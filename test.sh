...
# JS Files to test
declare -a jsfiles=("kv-map" "IdGenerator" "priority_queue" "bst" "test262/switch-01" "test262/switch-02" "test262/try-catch-01" "test262/try-catch-02" "test262/try-catch-03" "counter1" "counter2" "map" "function_test1_fail" "function_test3" "closure1" "closure2")
# JSIL Files to test
