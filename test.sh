...
# JS Files to test
declare -a jsfiles=("closure1" "closure2" "counter1" "counter2" "function_test1_fail" "function_test3" "paper_queue" "thesis_queue" "bst" "sort" "DOM/nodelist_DOM" "DOM/new_DOM")
# JSIL Files to test
