...
# JS Files to test
declare -a jsfiles=("paper_queue" "thesis_queue" "function_test0" "function_test1" "function_test2" "function_test3")
# JSIL Files to test
...
do
	...
	res=$(./jsilverify.native -file $f.jsil -js -newencoding | tail -n1)
