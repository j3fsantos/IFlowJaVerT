...
\myparagraph{Example}
To get a better intuition of the symbolic execution, let us observe the code snippet on the right and its symbolic execution in Figure~\ref{fig:sexecexample} (right). 
This code: 
