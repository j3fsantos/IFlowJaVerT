...
for control flow commands. All rules can be found in the Appendix. 
...
denotes the concrete state obtained by erasing negative-resource information in $\istate$, that is,  
