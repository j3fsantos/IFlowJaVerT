...
\dtag{4} $i$ is the command index to which the control jumps after executing $\pid$ in case of normal return; 
and \dtag{5} $j$ is the command index to which it jumps in case of error return. 
...
%  \\
 ...
 \quad \;
   ...
   { 
         \loc \text{ fresh}%(\loc, -) \in \domain(\jstate.\hpsel)
...
The remaining rules are not instructive and can be seen in the Appendix.
