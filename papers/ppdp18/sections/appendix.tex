...
%
$\val \in \vals$ \defeq\ $\jnumber \! \mid \! \jbool \! \mid \! \jstring \! \mid \! {\small \jundefined} \! \mid \! {\small \jnull} \! \mid \! {\small \jempty} \! \mid \! \loc \! \mid \! \jtype \! \mid \!  \pid \! \mid \! \jsillist{\val_i\!\!\mid_{i=0}^n} \! \mid \! \jsilset{\val_i \!\!\mid_{i=0}^n}$
   \\[0.1cm]
 %
...
%
$\proc \in \procs$ \defeq \ $\procedure{\pid}{\jvec{\jvar}}{\jvec{\jcmd}}$ \\[0.1cm]
$i, j \in \indexes$ \defeq \ $\mathbb{N} \cup \{ \retlab, \errlab \}$
 \end{tabular}
 \vspace*{-0.2cm}
  ...
  {}{  
      {\begin{array}{c}
       ...
       %
        ...
        \qquad
        \evalexpr{\symbolic}(\sstore, \svar) \semeq \svar 
	%
	 \\[10pt]
	 %
	\frac{
...
\begin{temax}[Frame Property of Instrumented Semantics-Theorem~\ref{teo:frame:property}]
$$
\begin{array}{l} 
...
From \hyp{2} and \ieq{3}, it follows that $\istate = \interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc)$ (\ieq{4}). 
...
From \hyp{2}, we conclude that $\istate = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \pc)$ (\ieq{4}). 
...
$ \interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc) = \stupdt{\instrumented}(\istate, \jvar, \interpret{\symbconc}{\senv}(\sexprv))$ (\ieq{6}). 
From \ieq{5} and \ieq{6}, we conclude that $\absbsemrule{\istate, \jvar := \getfields(\jsilexpr)}{\interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc)}{\instrumented}$, establishing the result. 
\vspace{5pt}
...
that $ \interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc) = \stupdt{\instrumented}(\istate, \jvar, \interpret{\symbconc}{\senv}(\sexprv))$ (\ieq{6}). 
Combining \ieq{5} and \ieq{6}, we conclude that $\absbsemrule{\istate,\jvar := \jsilexpr}{\interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc)}{\instrumented}$, establishing the result. 
\vspace{5pt}
...
we conclude that $\istate = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \pc)$ (\ieq{4}). 
...
$(\loc, \protop, \jnull) = \interpret{\symbinst}{\senv}(\sloc, \protop, \jnull)$ (\ieq{8})
and $\istate = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \pc)$ (\ieq{9}). 
Applying Lemma \ref{lemma:soundiness:heap:update} to \ieq{3}, \ieq{7}, \ieq{8}, and \ieq{9}, 
the result follows. 
\vspace{5pt}
...
$\istate = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \pc \, \wedge \, \sstate''.\pcsel)$ (\ieq{4}). 
...
where $\istate'' = \interpret{\symbinst}{\senv}(\sstate'' \, \wedge \, \pc)$ (\ieq{6}) and $\ival = \interpret{\symbconc}{\senv}(\sexprv)$ (\ieq{7}). 
Applying Lemma~\ref{lemma:soundiness:store:update} to \ieq{3}, \ieq{6}, and \ieq{7}, it follows
that  $\interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc) = \stupdt{\instrumented}(\istate'', \jvar, \ival)$ (\ieq{8}). 
...
where: $\istate'' = \interpret{\symbinst}{\senv}(\sstate'' \, \wedge \, \pc)$ (\ieq{6}), 
...
$\istate = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \pc \, \wedge \, \sstate''.\pcsel)$ (\ieq{5}). 
...
where: $\istate'' = \interpret{\symbinst}{\senv}(\sstate'' \, \wedge \, \pc)$ (\ieq{7}) and 
...
where $\istate'' = \interpret{\symbinst}{\senv}(\sstate'' \, \wedge \, \pc)$ (\ieq{7}) and $\ival = \interpret{\symbconc}{\senv}(\sexprv)$ (\ieq{8}). 
...
there is an instrumented state $\istate'$ such that: 
$\absbsemrule{\istate, \bcmd}{\istate'}{\instrumented}$ (\ieq{4}), and $\istate' = \interpret{\symbinst}{\senv}(\sstate' \, \wedge \, \pc)$ (\ieq{5}). 
From \ieq{2} and \ieq{4}, we conclude that $\abssemrule{\istate, \cs, i}{\istate', \cs, i{+}1}{\top}{\top}{\instrumented}$ (\ieq{6}). 
 Combining \hyp{2}, \ieq{5}, and \ieq{6}, we obtain the result.  
 \vspace{5pt}
...
$\interpret{\symbconc}{\senv}(\sstate' \, \wedge \, \pc) = \istate[\stosel \mapsto  [\jvar_i \mapsto \interpret{\symbconc}{\senv}(\sexprv_i) \mid_{i = 0}^{m}]]$ (\ieq{13}). 
...
$\transabssemrule{\istate, \cs, i}{\istate'', \cs'', k}{\mode}{\mode''}{\instrumented}$ (\ieq{5}), and
$(\istate'', \cs'') = \interpret{\symbinst}{\senv'}(\sstate'' \, \wedge \, \pc, \scs'')$ (\ieq{6}).
Applying Lemma~\ref{soundiness:control:flow:cmds} to \hyp{2} and \ieq{2},
it follows that  
$\abssemrule{\istate'', \cs'', k}{\istate', \cs', j}{\mode}{\mode'}{\instrumented}$ (\ieq{7}), 
$(\istate', \cs') = \interpret{\symbinst}{\senv''}(\sstate' \, \wedge \, \pc, \cs')$ (\ieq{8}), and 
$\senv'' \fextends  \senv$ (\ieq{9}). 
Combining \ieq{5} and \ieq{7}, we conclude that 
$\abssemrule{\istate, \cs, i}{\istate', \cs', j}{\mode}{\mode'}{\instrumented}$ (\ieq{10}). 
Combining \ieq{8}, \ieq{9}, and \ieq{10}, we obtain the result. 
\end{proof}
