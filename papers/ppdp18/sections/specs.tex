...
$$
\begin{array}{l}
\testify{}(\specsig{\pass}{\pid(\jvec{x})}{\qass}{\flag})  = (\proc, \sheap) \, \wedge \, 
  \prog[\jsilmain \mapsto \proc] : \\ \quad \quad %\symbtranstranserr{\sheap, [], i, \pc}{\sctxmain}{\pc'} \\
    \implies  \prog \not\satisfies \specsig{\pass}{\pid(\jvec{x})}{\qass}{\flag}
\end{array}
$$
\noindent where $\csmain$ denotes the initial call stack: $[ (\jsilmain, -, -, -) ]$.
\end{theorem}
