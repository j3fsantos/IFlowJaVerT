...
Let $\sstate = (, \storeemp, , \pc)$, where $\pc$ describes that $\sexprp_1$, $\sexprp_2$, $\sexprp_3$, and $\sexprp_4$ are all different, and let the next assertion to be unified be $\emptyfields{\loc}{\{ \sexprp_1, \sexprp_2, \sexprp_3, \sexprp_4 \}}$.
