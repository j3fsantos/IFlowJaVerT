...
set denoted by $\lexpr_2$. \pmaxinline{Mention sth about Es being the same.} %The syntax of assertions is given below. 
...
\begin{tabular}{l}
  %%%%
  $\lexpr \quad \ \triangleq \val \mid \jvar \mid \svar \mid \unoper\ \lexpr \mid \lexpr \binoper \lexpr \quad \quad \quad \quad \quad \quad \quad \ \ $   \hfill Logical Exprs. \\
