...
\myparagraph{Formal Guarantees} Our $\unificationfun(\sstate, \pass)$ partial decision procedure satisfies the criteria outlined in \S\ref{subsec:sep:assertions}. The proof is  in the Appendix.
