...
None of them can be used to test specs.}
...
The key insight of \emph{Target} is to combine the approach of \emph{Quickcheck} 
with the use of an SMT solver for finding satisfying models for the supported type refinements. 
