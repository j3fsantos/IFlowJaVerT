...
There is also the work of \citet{swamy:pldi:2013}, who prove absence of runtime errors for higher-order JavaScript (ES3) programs by: compiling JS programs annotated with assertions and loop invariants to the logic of F*; generating verification conditions for the absence of runtime errors; and automatically discharging these conditions using Z3. However, as this analysis does not deal with specifications, it was not possible for us to re-use its results for \cosette. 
