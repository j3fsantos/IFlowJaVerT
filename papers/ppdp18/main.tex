...
\pgmaxinline{This next paragraph is very clunky, but says the main
  ...
  We introduce \cosette, a symbolic execution toolchain for JavaScript
  (ECMAScript 5 Strict~\cite{ecma} \footnote{It is straightforward to
    extend this work to the non-strict case. Later extensions and
...
interpreter can be described in three steps: \dtag{1} design an JSIL
...
object in order for the program to behave correctly; \dtag{2} define
the JSIL symbolic semantics by lifting the JSIL instrumented
semantics; and \dtag{3} link the JSIL symbolic semantics to the
