...
in that it comes with formal correctness guarantees and a result stating the precise conditions under which symbolic execution gives soundness. We create \cosette following a new, general methodology for compositional analysis of dynamic~languages.
