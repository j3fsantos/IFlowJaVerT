...
First, the symbolic execution of \jilette is \emph{trustworthy}, in that it is formalised, proven sound, and precisely follows the ES5 English standard. 

Second, the symbolic execution of \jilette is \emph{compositional}. 

\myparagraph{Trustworthiness} This

\myparagraph{Compositionality} That

\myparagraph{Application: Symbolic Testing} This

\myparagraph{Application: Specification-directed bug-finding} That
