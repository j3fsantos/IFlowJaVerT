...
\begin{lemma}[Heap Update - Symbolic Semantics]
$$
\begin{array}{l}
\istate \in \interpret{\symbinst}{\senv}(\sstate) \, \wedge \, 
   \loc \in \interpret{\symbconc}{\senv}(\sloc)  \, \wedge \, 
   p \in \interpret{\symbconc}{\senv}(\sexprp)  \, \wedge \, 
   \val \in \interpret{\symbconc}{\senv}(\sexprv)   \\  \qquad \qquad
       \implies \hpupdt{\instrumented}(\istate, \loc, p, \val) \in \interpret{\symbconc}{\senv}(\hpupdt{\symbolic}(\sstate, \sloc, \sexprp, \sexprv)) \\[3pt]
%       
\istate \in \interpret{\symbinst}{\senv}(\sstate) \, \wedge \, 
   \loc \in \interpret{\symbconc}{\senv}(\sloc)  \, \wedge \, 
   p \in \interpret{\symbconc}{\senv}(\sexprp) \\  \qquad \qquad
  \implies \hpupdt{\instrumented}(\istate, \loc, p, \none) \in \interpret{\symbconc}{\senv}(\hpupdt{\symbolic}(\sstate, \sloc, \sexprp, \none)) 
\end{array}
$$
\end{lemma}
\begin{proof}
...
\begin{lemma}[Store Update - Symbolic Semantics]
$$
\begin{array}{l}
\istate \in \interpret{\symbinst}{\senv}(\sstate) \, \wedge \, 
   \val \in \interpret{\symbconc}{\senv}(\sexprv)   
       \implies \stupdt{\instrumented}(\istate, \jvar, \val) \in \interpret{\symbconc}{\senv}(\stupdt{\symbolic}(\sstate, \jvar, \sexprv))
\end{array}
$$
\end{lemma}
\begin{proof}
...
\begin{lemma}[Assume - Symbolic Semantics]
$$
\begin{array}{l}
\istate \in \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \sstate'.\pcsel)  
       \implies  \interpret{\symbinst}{\senv}(\absassume{\instrumented}(\istate, \jsilexpr)) \in \absassume{\symbolic}(\sstate, \jsilexpr) 
\end{array}
$$
\end{lemma}
\begin{proof}
Assume that $\istate \in \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \sstate'.\pcsel)$ (\hyp{1}).
...
\begin{lemma}[Check Sat - Symbolic Semantics]
$$
\begin{array}{l}
      \abssat{\symbolic}(\sstate, \jsilexpr) = \jtrue   
      \implies  \exists \, \istate, \senv \, . \, 
           \istate \in \interpret{\symbinst}{\senv}(\sstate)
           \, \wedge \, 
          \absassume{\instrumented}(\istate, \jsilexpr) = \jtrue
\end{array}
$$
\end{lemma}
\begin{proof}
Assume that $\abssat{\symbolic}(\sstate, \jsilexpr) = \jtrue$ (\hyp{1}).
\end{proof}



\begin{temax}[Theorem~\ref{lemma:soundness:jsil:symb:exe:instrumented:instrumented} - Soundiness wrt Instrumented Semantics]
