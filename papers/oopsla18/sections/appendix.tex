...
\begin{lemma}[Expression Evaluation - Soundiness for Symbolic Semantics]\label{symb:eval:expr}
$$
...
\begin{lemma}[Heap Update - Soundiness for Symbolic Semantics]\label{lemma:soundiness:heap:update}
$$
\begin{array}{l}
...
\begin{lemma}[Store Update - Soundiness for Symbolic Semantics]\label{lemma:soundiness:store:update}
$$
\begin{array}{l}
\istate = \interpret{\symbinst}{\senv}(\sstate) \, \wedge \, 
...
\begin{lemma}[Assume - Soundiness for Symbolic Semantics]\label{lemma:soundiness:assume}
$$
\begin{array}{l}
...
\begin{lemma}[Check Sat - Soundiness for Symbolic Semantics]
$$
\begin{array}{l}
...
\begin{lemma}[Symbolic Value Creation - Soundiness for Symbolic Semantics]\label{lemma:symbvalue:soundiness}
$$
...
\begin{lemma}[GetCell - Soundiness for Symbolic Semantics]\label{soundiness:getcell}
$$
\begin{array}{l}
...
From \hyp{1} and \ieq{3}, we conclude that: 
 ...
 $\absgetcellrule{\instrumented}{\istate, \jsilexpr_1, \jsilexpr_2}{\istate, (\loc, p, \ival)}$ (\ieq{15}), 
...
\begin{lemma}[GetDomain - Soundiness for Symbolic Semantics]\label{lemma:getdomain:soundiness}
$$
\istate = \interpret{\symbinst}{\senv}(\sstate) \ \wedge \ 
...
From \hyp{1} and \ieq{4}, it follows that $\jsilset{\interpret{\symbconc}{\senv}(\sexprp_1), ..., \interpret{\symbconc}{\senv}(\sexprp_m)} = \interpret{\symbconc}{\senv}(\sdom(\sloc))$ (\ieq{6}).
Applying Lemma XXX to \ieq{6} and using \ieq{3}, we conclude that 
 $\jsilset{\interpret{\symbconc}{\senv}(\sexprp_1), ..., \interpret{\symbconc}{\senv}(\sexprp_m)} = (\interpret{\symbinst}{\senv}(\sdom))(\loc)$ (\ieq{7}). 
...
\begin{lemma}[Basic Commands - Soundiness for Symbolic Semantics]\label{lemma:soundiness:basic:commands}
$$
...
\noindent \prooflab{Property Collection} From \hyp{1}, it follows that $\absbsemrule{\sstate, \jvar := \getfields(\jsilexpr)}{\sstate'}{\symbolic}$ (\ieq{1}). 
From \ieq{1}, we conclude that there is a symbolic value $\sexprv$ such that 
$\absgetdomainrule{\symbolic}{\sstate, \jsilexpr}{\sexprv}$ (\ieq{2}) 
...
$\absgetdomainrule{\instrumented}{\istate, \jsilexpr}{\interpret{\symbconc}{\senv}(\sexprv)}$ (\ieq{5}). 
...
\vspace{5pt}
 ...
 \noindent \prooflab{Property Access} From \hyp{1}, it follows that $\absbsemrule{\sstate, \jvar := \jvar := [\jsilexpr_1, \jsilexpr_2]}{\sstate'}{\symbolic}$ (\ieq{1}). 
...
From \hyp{1}, it follows that $\absbsemrule{\sstate, [\jsilexpr_1, \jsilexpr_2] := \jsilexpr_3}{\sstate'}{\symbolic}$ (\ieq{1}). 
...
$\absgetcellrule{\symbolic}{\sstate, \jsilexpr_1, \jsilexpr_2}{\sstate'', (\sloc, \sexprp, -)}$ (\ieq{2}) and 
...
From \hyp{1}, it follows that $\absbsemrule{\sstate, \jsildelete(\jsilexpr_1, \jsilexpr_2)}{\sstate'}{\symbolic}$ (\ieq{1}). 
...
$\absgetcellrule{\symbolic}{\sstate, \jsilexpr_1, \jsilexpr_2}{\sstate'', (\sloc, \sexprp, \sexprp)}$ (\ieq{2}), 
$\sexprp \neq \none$ (\ieq{3}), and  
...
From \hyp{1}, it follows that $\absbsemrule{\sstate, \jvar := \hasfield(\jsilexpr_1, \jsilexpr_2)}{\sstate'}{\symbolic}$ (\ieq{1}). 
From \ieq{1}, we conclude that there is a symbolic expression $\sexprv$, and a symbolic state $\sstate''$ such that 
...
From \hyp{1}, it follows that $\absbsemrule{\sstate, \jvar := \jvar := \makesymbolic(\jtype)}{\sstate'}{\symbolic}$ (\ieq{1}). 
...
\begin{lemma}[Control Flow Commands - Soundiness for Symbolic Semantics]
$$
\begin{array}{l} 
\abssemrule{\sstate, \scs, i}{\sstate', \scs', j}{\mode}{\mode'}{\symbolic} \, \wedge \, (\istate, \cs) = \interpret{\symbinst}{\senv}(\sstate \, \wedge \, \sstate'.\pcsel, \scs)  \\ \quad \quad
     \implies 
        \exists \, \istate' \, . \, \abssemrule{\istate, \cs, i}{\istate', \cs', j}{\mode}{\mode'}{\instrumented}
         \, \wedge \, 
            (\istate', \cs') = \interpret{\symbinst}{\senv'}(\sstate', \cs')  \, \wedge \, 
            \senv' \fextends  \senv
 \end{array}
$$
\end{lemma}
...
From \hyp{1}, it follows that $\abssemrule{\sstate, \scs, i}{\sstate', \cs, i{+}1}{\top}{\top}{\symbolic}$ (\ieq{1}), 
$\ccmd[\prog][\abscs]{i} = \bcmd$ (\ieq{2}), and $\absbsemrule{\sstate, \bcmd}{\sstate'}{\symbolic}$ (\ieq{3}). 
...
$\ccmd[\prog][\abscs]{i} =  \ifgoto{\jsilexpr}{j}{k}$ (\ieq{2}), and 
...
From \ieq{2} and \ieq{4}, we conclude that $\abssemrule{\istate, \cs, i}{\interpret{\symbinst}{\senv}(\sstate'), \cs, i{+}1}{\top}{\top}{\instrumented}$ (\ieq{5}).
Combining \hyp{2} and \ieq{5}, we obtain the result.     
 \vspace{5pt}

\noindent \prooflab{Cond. Goto - True} Similar to \prooflab{Cond. Goto - True}. 
 \vspace{5pt}
 
\noindent \prooflab{Goto} From \hyp{1}, it follows that $\abssemrule{\sstate, \scs, i}{\sstate, \scs, j}{\top}{\top}{\symbolic}$ (\ieq{1}),   
where $\ccmd[\prog][\abscs]{i} = \goto \, j$ (\ieq{2}). 
From \ieq{2}, we conclude that 
$\abssemrule{\istate, \cs, i}{\istate, \cs, j}{\top}{\top}{\instrumented}$ (\ieq{3}).
...
and $\sstate' = \stupdt{\symbolic}(\sstate[\stosel \mapsto \sstore'], \jvar, \sstore(\retvar))$ (\ieq{4}). 
...
Applying Lemma~\ref{lemma:soundiness:store:update} to \hyp{2}, \ieq{4} and \ieq{6}, we conclude that $\stupdt{\instrumented}(\istate[\stosel \mapsto \interpret{\symbconc}{\senv}(\sstore')], \jvar, \istate.\stosel(\retvar)) = \interpret{\symbinst}{\senv}(\sstate')$ (\ieq{7}). 
From \ieq{5} and \ieq{7}, we conclude that $\abssemrule{\istate, \scs, \retlab}{\interpret{\symbinst}{\senv}(\sstate'), \interpret{\symbconc}{\senv}(\scs'), i}{\top}{\top}{\instrumented}$, 
establishing the result. 
 \vspace{5pt}
...
%       \store = \jstate.\stosel
%       \\\\
%       \jstate' = \jstate[\stosel \mapsto \store'[\jvar \mapsto \store(\procretvar)]]
%   }  
...
%       \store = \jstate.\stosel
%       \\\\
%       \jstate' = \jstate[\stosel \mapsto \store'[\jvar \mapsto \store(\procerrvar)]]
%   }  
...
%   { \ccmd[\prog][\abscs]{i} =  \ifgoto{\jsilexpr}{j}{k} 
%     \\\\
%     \absassume(\absstate, \jsilexpr = \jtrue) = \absstate' 
%   }
%   {\abssemrule{\absstate, \abscs, i}{\absstate', \abscs, j}{\top}{\top}}
%  %
%  \and 
...
%   { \ccmd[\prog][\abscs]{i} =  \ifgoto{\jsilexpr}{j}{k} 
%      \\\\ 
%      \absassume(\absstate, \jsilexpr = \jfalse) = \absstate' 
%   }
...
%       \quad 
%       \absstore = \jstate.\stosel
%       \\\\
%       \absstate' = \absstate[\stosel \mapsto \absstore'[\jvar \mapsto \absstore(\procretvar)]]
%   }  
%   {\abssemrule{\absstate, \abscs, \procretlab}{\absstate', \abscs', i}{\top}{\top}}
%     %
%   \qquad 
%   %
%      \inferrule[\textsc{Error Return}]
...
%       \absstore = \absstate.\stosel
%       \\\\
%       \absstate' = \absstate[\stosel \mapsto \absstore'[\jvar \mapsto \absstore(\procerrvar)]]
%   }  
%   {\abssemrule{\absstate, \abscs, \procerrlab}{\absstate', \abscs', j}{\top}{\top}}
%      \\
%    \inferrule[\textsc{Procedure Call}]
%   { 
...
%     \absstore = \absstate.\stosel 
%     \and 
%    \evalexpr(\jsilexpr, \absstore) =  \pid' 
%        \and
%     \args(\pid', \prog) = \jsillist{\jvar_1, ..., \jvar_{m}} 
%      \\\\
%      \absval_i = \evalexpr(\jsilexpr_i, \absstore) \mid_{i = 0}^{n} 
%     \and
%      \absval_i = \jsundefined \mid_{i = n+1}^{m}  
%      \and 
%      \absstore' = [ \jvar_i \mapsto \val_i \mid_{i = 0}^{m}]
%      \and 
...
%      \evalexpr(\jsilexpr, \absstore) =  \absval
%      \\\\
%     \absassume(\absstate, \absval) = \absstate' 
%  }{\abssemrule{\absstate, \abscs, i}{\absstate', \abscs, i{+}1}{\top}{\top}} 
%\and
%\inferrule[\textsc{Assert - True}]
%  { 
...
%%\vspace*{-0.3cm}
%\begin{figure}[ht!]
%\hspace{0.5cm}\textbf{Symbolic Semantics Rules:\hfill}
%{\scriptsize
%\begin{mathpar} 
%  \inferrule[\textsc{GetDomain}]
%   { 
%        \symbeval{\jsilexpr}{\sstore} = \sloc
%      \quad
...
%   }{  \absgetdomainrule{(\sheap, \sdom, \sstore, \pc), \jsilexpr}{\jsilset{\sexprp_1, ..., \sexprp_n}}}
%  \and
% % 
%     \inferrule[\textsc{GetCell - Domain}]
%   { 
%         \symbeval{\jsilexpr_1}{\sstore} = \sloc
%        \quad 
%         \symbeval{\jsilexpr_2}{\sstore} = \sexprp
%      \quad
%       \sheap = \sheap'' \, \uplus \, \big((\sloc, \sexprp_i) \mapsto \sexprv_i \big)\mid_{i = 0}^m
%      \\\\
%       (\sloc,-) \notin \domain (\sheap'')
...
%   }{  \absgetcellrule{(\sheap, \sdom, \sstore, \pc), (\jsilexpr_1, \jsilexpr_2)}{(\sheap', \sdom', \sstore, \pc'), (\sloc, \sexprp, \none)}}
%  %
%  \\
%  %
...
%   }{  \absgetcellrule{(\sheap, \sdom, \sstore, \pc), (\jsilexpr_1, \jsilexpr_2)}{\sstate', (\sloc, \sexprp, \sexprv)}}
% %
% \and 
...
%   }{  \hpupdt(\sstate, (\sloc, \sexprp), \sexprv) =  (\sheap', \sdom, \sstore, \pc) }
%\\
%  %
%      \inferrule[\textsc{Assume}]
%   { 
%         \sstate = (\sheap, \sdom, \sstore, \pc) 
%   }{  \absassume(\sstate, \sexprv) =  (\sheap, \sdom, \sstore, \pc \wedge (\sexprv = \jtrue)) }
%  \qquad 
...
%   }{  \abssat(\sstate, \sexprv) = \jfalse}
% \end{mathpar}}
%%
%%
%{\hspace{0.5cm}\textbf{Instrumented Semantics Rules:\hfill}
%{\scriptsize
%\begin{mathpar} 
% \inferrule[\textsc{GetDomain}]
%   { 
...
%   }{  \absgetdomainrule{(\iheap, \idom, \store), \jsilexpr}{\jsilset{p_1, ..., p_n}}}
%  \and
% % 
%     \inferrule[\textsc{GetCell - Domain}]
%   { 
...
%     }{  \absgetcellrule{(\iheap, \idom, \store), (\jsilexpr_1, \jsilexpr_2)}{(\iheap', \idom', \store), (\loc, p, \none)}}
%  %
%  \\
%  %
%    \inferrule[\textsc{GetCell - Explicit Cell}]
...
%        }{  \absgetcellrule{(\iheap, \idom, \store), (\jsilexpr_1, \jsilexpr_2)}{(\iheap, \idom, \store), (\loc, p, \val)}}
% %
% \and 
%       \inferrule[\textsc{Heap Update}]
%   { 
...
%   }{  \hpupdt(\istate, (\loc, p), \val) =  (\iheap, \idom, \store) }
%\\
%  %
%      \inferrule[\textsc{Assume}]
%   {}{  \absassume(\istate, \jtrue) =  \istate }
%  \and
%    \inferrule[\textsc{Satisfiable}]
%   {}{  \abssat(\istate, \jbool) = \jbool}
% \end{mathpar}}}
% %
%%
%{\hspace{0.5cm}\textbf{Concrete Semantics Rules:\hfill}
%{\scriptsize
%\begin{mathpar} 
%  \inferrule[\textsc{GetDomain}]
%   { 
...
%      \quad
%          (\loc,-) \notin \domain (\heap')  
%       }{  \absgetdomainrule{(\heap, \store), \jsilexpr}{\jsilset{p_1, ..., p_n}}}
%  %
%  \and
%  %
%    \inferrule[\textsc{GetCell - Explicit Cell}]
...
%        }{  \absgetcellrule{(\heap, \store), (\jsilexpr_1, \jsilexpr_2)}{(\heap, \store), (\loc, p, \val)}}
% %
% \\
...
%         \quad 
%         \val \neq \none
%   }{  \hpupdt(\jstate, (\loc, p), \val) =  (\heap', \store) }
% \and
%       \inferrule[\textsc{Heap Update - $\none$}]
%   { 
%         \jstate = (\heap, \store) 
...
%  %
%      \inferrule[\textsc{Assume}]
%   {}{  \absassume(\jstate, \jtrue) =  (\jstate, \jtrue) }
%\and 
%    \inferrule[\textsc{Satisfiable }]
%   {}{  \abssat(\jstate, \jbool) = \jbool}
% \end{mathpar}}}
%\end{figure}
%
%
