...
\begin{lemma}[Heap Update - Soundiness for Symbolic Semantics]
$$
\begin{array}{l}
...
\begin{lemma}[Store Update - Soundiness for Symbolic Semantics]
$$
\begin{array}{l}
\istate = \interpret{\symbinst}{\senv}(\sstate) \, \wedge \, 
...
\begin{lemma}[Assume - Soundiness for Symbolic Semantics]
$$
\begin{array}{l}
...
\begin{lemma}[Symbolic Value Creation - Soundiness for Symbolic Semantics]
$$
...
\begin{lemma}[GetCell - Soundiness for Symbolic Semantics]
$$
\begin{array}{l}
...
\begin{lemma}[GetDomain - Soundiness for Symbolic Semantics]
$$
\istate = \interpret{\symbinst}{\senv}(\sstate) \ \wedge \ 
...
\begin{lemma}[Basic Commands - Soundiness for Symbolic Semantics]
$$
...
\noindent \prooflab{Property Collection} It follows that $\absbsemrule{\sstate, \jsilskip}{\sstate}{\symbolic}$ (\ieq{1}) and 
$\absbsemrule{\istate, \jsilskip}{\istate}{\instrumented}$ (\ieq{2}). 
From \hyp{1} and \ieq{1}, we conclude that $\sstate' = \sstate$ (\ieq{3}). 
From \hyp{2} and \ieq{3}, it follows that $\istate \in \interpret{\symbinst}{\senv}(\sstate')$ (\ieq{4}). 
Letting $\istate' = \istate$, the result follows from \ieq{2} and \ieq{4}. 
