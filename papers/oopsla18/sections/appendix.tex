...
\begin{mathpar} 
 ...
 % 
   ...
   { 
      ...
      \\\\
       ...
       \quad 
       \pc' = \pc \wedge \sexprp \not\in \sexprv \cup \jsilset{\sexprp_i \mid_{i=0}^n}
   }{  \absgetcellrule{(\sheap, \sdom, \sstore, \pc), (\jsilexpr_1, \jsilexpr_2)}{(\sheap'', \sdom', \sstore, \pc'), (\sloc, \sexprp, \sexprv)}}
  %
  \\
  %
 ...
 \and 
   ...
   { 
         \absstate = (\sheap, \sdom, \sstore, \pc) 
         \quad 
         \sheap' = \sheap[(\sloc, \sexprp) \mapsto \sexprv]
   }{  \hpupdt(\sheap, (\sloc, \sexprp), \sexprv) =  (\sheap', \sdom, \sstore, \pc) }
\\
  %
      \inferrule[\textsc{Assume}]
   { 
         \absstate = (\sheap, \sdom, \sstore, \pc) 
   }{  \absassume(\absstate, \pc') =  (\sheap, \sdom, \sstore, \pc \wedge \pc') }
  \qquad 
   ...
   { 
         ...
         \quad 
         (\pc \wedge \pc') \text{ SAT}
   }{  \abssat(\absstate, \pc') = \jtrue}
 \qquad 
    \inferrule[\textsc{Satisfiable - False}]
   { 
         \pc = \absstate.\pcsel 
         \quad 
         (\pc \wedge \pc') \text{ UNSAT}
   }{  \abssat(\absstate, \pc') = \jfalse}
 \end{mathpar}}
%
%
...
\begin{mathpar} 
   ...
   { 
      ...
      \\\\
       (\loc,-) \notin \domain (\iheap')
        ...
        \idom(\loc) = \val_d
        \quad 
       p \not\in \val_d \cup \jsilset{p_i \mid_{i=0}^n})
       \\\\
 ...
 \and 
   ...
   { 
         ...
         \quad 
         \sheap' = \sheap[(\sloc, \sexprp) \mapsto \sexprv]
   }{  \hpupdt(\absheap, (\sloc, \sexprp), \sexprv) =  (\sheap', \sdom, \sstore, \pc \wedge \pc') }
\\
  %
      \inferrule[\textsc{Assume}]
   { 
