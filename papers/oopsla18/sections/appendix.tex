...
\begin{lemma}[Check Sat - Soundiness for Symbolic Semantics]\label{lemma:soundiness:sat}
$$
\begin{array}{l}
...
\begin{lemma}[Control Flow Commands - Soundiness for Symbolic Semantics]\label{soundiness:control:flow:cmds}
$$
\begin{array}{l} 
...
From \ieq{2} and \ieq{4}, we conclude that 
 $\abssemrule{\istate, \cs, i}{\interpret{\symbinst}{\senv}(\sstate'), \cs, i{+}1}{\top}{\top}{\symbolic}$ (\ieq{5}). 
 \vspace{5pt}

\noindent \prooflab{Assert - True}
From \hyp{1}, it follows that $\abssemrule{\sstate, \scs, i}{\sstate, \scs, i{+}1}{\top}{\top}{\symbolic}$ (\ieq{1}), 
$ \ccmd[\prog][\scs]{i}  = \assert(\jsilexpr)$ (\ieq{2}), and $\abssat{\symbolic}(\sstate, \neg \jsilexpr) = \jfalse$ (\ieq{3}). 
...
\begin{lemma}[Soundiness of the \jsil symbolic execution: Symbolic-to-Instrumented (1)]\label{lemma:full:soundiness}
$$
\begin{array}{l} 
