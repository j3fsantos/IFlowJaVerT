...
We present our symbolic execution engine for \jsil~\cite{javert}. 

\jfs{
\begin{itemize}
   \item The concrete and symbolic semantics of \jsil are defined by means of an 
            abstract semantics that can be parameterised with the appropriate state for 
            obtaining both the concrete semantics and the symbolic semantics.
            This approach has a great many number of benefits: \dtag{1} it avoids redundancy, 
            \dtag{2} it makes the choices in the design of the symbolic semantics more explicit, 
            and \dtag{3} it leads to more modular implementations, avoiding code duplication.  
            
  \item We present the theoretical underpinnings of our symbolic analysis, including a soundness
           result and a guarantee of absence of false positives for bug-finding.
\end{itemize}
}
