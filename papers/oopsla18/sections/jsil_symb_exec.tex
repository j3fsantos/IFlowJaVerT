...
\qquad
\frac{
   l = \semexpr{\sexprl}{\senv} \quad p = \semexpr{\sexprp}{\senv} \quad v = \semexpr{\sexprp}{\senv}
}{
...
\qquad
\frac{
   \semexpr{\sheap_1}{\senv} = h_1, \hdom_1
   \quad 
   \semexpr{\sheap_2}{\senv} = h_2, \hdom_2
}{
...
\inferrule[Symbolic States]{
   ...
   \quad
    ...
    \quad 
    \domain(h') \cap (\domain(h) \cup \hdom_1 \cup \hdom_2) = \emptyset
}{
\jmodels{\symbolic}(\sstate, \scs) \semeq (h \dunion h', \store) 
}
\end{mathpar}}
\end{display}
...
$\abssemrule{\sstate, \scs, i}{\sstate', \scs', j}{\mode}{\mode'}{\symbolic}$ and a concrete CF-state $(\jstate, \cs)$
...
$\abssemrule{\jstate, \cs, i}{\jstate', \cs', j}{\mode}{\mode'}{\concrete}$. 
...
$$
\begin{array}{l}
\abssemrule{\sstate, \scs, i}{\sstate', \scs', j}{\mode}{\mode'}{\symbolic}  \ \wedge \ (\jstate, \cs) \in \jmodels{\symbolic}(\sstate[\pcsel \mapsto \sstate'.\pcsel], \scs) \\ \quad \quad 
    \ \implies \ \exists \jstate', \cs' \, . \, 
        \abssemrule{\jstate, \cs, i}{\jstate', \cs', j}{\mode}{\mode'}{\concrete} \ \wedge \ (\jstate', \cs') \in \jmodels{\symbolic}(\sstate', \scs')
\end{array}
$$
\end{theorem}
...
$$
\begin{array}{l}
\wedge_{k=1}^n \, \big( \abssemrule{\sstate, \scs, i}{\sstate_k, \scs_k, j_k}{\mode}{\mode_k}{\symbolic}  \big)
...
%
      \ \implies \ \exists 1 \leq l \leq n, \jstate', \cs' \, . \, 
           \abssemrule{\jstate, \cs, i}{\jstate', \cs', j_l}{\mode}{\mode_l}{\concrete}
           \, \wedge \, 
...
%
  \and 
   ...
   { 
         \store' = \store[\jvar \mapsto \val]
   }{  \stupdt{\instrumented}((\iheap, \idom, \store), \jvar, \val) =  (\heap, \store')}
 %
 \and
 % 
       \inferrule[\textsc{Heap Update}]
