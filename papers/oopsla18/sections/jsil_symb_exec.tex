...
\begin{mathpar} 
 ...
 \\
   ...
   { 
         ...
         \quad 
         \val \neq \none
   }{  \hpupdt{\concrete}(\jstate, \loc, p, \val) =  (\heap', \store) }
 \and
...
\myparagraph{Example:}
 To get a better intuition of how these rules work, let us take a look at the snippet of code shown on the right. 
This code: 
