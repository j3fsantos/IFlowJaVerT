...
They include the $\jsilskip$ command, variable assignment, object creation, property access, property assignment, property deletion, membership check, and property collection. 
...
\setlength{\itemsep}{0.2em}
  ...
  \item[GetCell,] $\getcell \subseteq \absstates \times \exprs \times \exprs \times \absstates \times \absvals \times \absvals \times \absvals$. 
          ...
          and \dtag{4} $\absstate'$ denotes the re-arrangement of $\absstate$ to allow for the property inspection (discussed shortly). 
  ...
  \item[GetDomain,] $\getdomain \subseteq \absstates \rightarrow \exprs \partialmap \absvals$. 
           ...
           set of abstract property names associated with the object at the abstract location resulting from the evaluation of $\jsilexpr$ 
           in $\absstate$. 
