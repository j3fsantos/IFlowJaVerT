...
\myparagraph{Replacing concrete unit tests with symbolic tests}
...
\subsubsection{\jsinline{buckets.arrays.swap}}
Original test:

Our test:

\subsubsection{\jsinline{buckets.bag.add} (or \jsinline{remove}?)}
Original test:
