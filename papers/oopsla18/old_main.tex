...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{\cosette: Symbolic Execution for JavaScript}
\titlerunning{\cosette: Symbolic Execution for JavaScript} %optional, in case that the title is too long; the running title should fit into the top page column
...
%\\usepackage[english]{babel} bkeywords{}% mandatory: Please provide 1-5 keywords
% Author macros::end %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This paper presents \cosette, a symbolic execution tool for JavaScript (ECMAScript 5, ES5~\cite{ecma}).
%
