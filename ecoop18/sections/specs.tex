...
\myparagraph{Specification Preliminaries} \polish{This is not the right place for this.} We separate multiple definitions of the same predicate using a comma. 
%
