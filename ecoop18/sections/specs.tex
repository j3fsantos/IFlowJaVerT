...
\end{itemize}
We also introduce iterated cell unification, denoted by $\rightarrow_{\cal CU}$ and defined simply in terms of cell unification, and also denote its transitive closure by $\rightarrow_{\cal CU}^*$. 
