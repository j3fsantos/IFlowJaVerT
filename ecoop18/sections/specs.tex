...
described in~\cite{javert}. In particular, we first convert the \javert specification into a \jsil Logic specification, 
using the translation of specifications; then, we generate a set of symbolic tests from the obtained \jsil Logic specification; 
