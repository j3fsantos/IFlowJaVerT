...
This means, for instance, for none-cell assertions corresponding to the same object, that their corresponding properties are 
...
given symbolic state entails some NR resource captured by a given set of NR-assertions $\efs$, it must be the case that the 
