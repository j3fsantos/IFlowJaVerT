...
\inferrule[\textsc{Cell Assertion}]
	...
	}{ \unification{\sheap, \sstore, \pc}{(\loc,\sexprp)\pointsto \sexprv}{} = \uyes{\sheap_f}} 
\and 
...
\inferrule[\textsc{Cell Assertion - Fail}]
	...
	}{ \unification{\sheap, \sstore, \pc}{(\loc,\sexprp)\pointsto \sexprv}{} = 
...
\inferrule[\textsc{Fail - Extra Resource}]
	{  
	     ...
	     \qquad
	     \sheap_f \neq \hemp
	}{\unificationfullfail{\sheap, \pc}{\emptyset, \efs, \pfs'}{\subst}{\jtrue}} 
%
\and
%
