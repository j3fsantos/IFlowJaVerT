...
\vspace{-3pt}
\begin{display}{Unification of non-none cell assertions: $\unification{\sheap, \sstore, \pc}{\cell}{} = \uyes{\sheap_f} \texttt{ or } \uno{\pc'}$}
{\scriptsize
\begin{mathpar} 
	...
	{  
	   ...
	   \sheap = \sheap' \dunion  \big((l, \sexprp_i) \mapsto \sexprv_i\big)\mid_{i = 0}^n  
	    \\\\ 
	     (l, -) \not\in \domain(\sheap') 
	     \quad
	    \pc_i = (\sexprp_i \neq \sexprp' \vee \sexprv_i \neq \sexprv')\!\mid_{i = 0}^n
	}{ \unification{\sheap, \sstore, \pc}{\cell}{} = 
		\uno{\wedge_{0 \leq i \leq n} \pc_i}} 
\qquad
...
\inferrule[\textsc{Sanity Constraints - Fixed Location}]
	{
		 \efproj{\efs}{\loc} = \emptyfields{\loc}{\sexpr_d} \sep  \oast_{i = 0}^{n} \, \big((l, \sexprp_i) \mapsto - \big)
	}{ \sanityl{\efs}{\loc} = 
		 (\wedge_{0 \leq i, j \leq n, i \neq j} \sexprp_i \neq \sexprp_j)
		       \, \wedge \,  \big(\{  \sexpr_i \mid_{i = 0}^n \} \subseteq \sexpr_d \big)
	} 
%
\\
...
\inferrule[\textsc{Fail - Pure Entailment}]
	...
	}{\unificationfullfail{\sheap, \pc}{\cells, \efs, \pfs'}{}{\pc'  \, \wedge \, \pc'' \wedge \, \pc'''}} 
\\
%
...
\inferrule[\textsc{Fail - Cell Unification}]
	{  
	   \cellunificationiter{\sheap, \cells}{\sheap', \cell \lstcons -}{\pc}
            \qquad
          \unification{\sheap', \sstore, \pc}{\cell}{} = \uno{\pc''}
