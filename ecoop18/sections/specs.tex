...
A symbolic test is a pair $(\proc, \sheap)$ consisting of a \jsil procedure and a symbolic heap. The test program 
is obtained by replacing the $\jsilmain$ of $\proc$ 
...
\begin{theorem}[Bug Finding for SL Specifications]
