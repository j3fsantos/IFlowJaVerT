...
\end{itemize}
We also introduce the iterated cell unification, $\rightarrow_{\cal CU}$, defined simply in terms of cell unification, and denote its transitive closure by $\rightarrow_{\cal CU}^*$. 
