...
\end{verbatim}}
%
\noindent We write \jsinline|-u-| for set union and omit the brackets around singleton 
sets when clear. 
%
...
below we show the specifications of \jsinline|get(k)| and \jsinline|put(k, v)| for the case in which
