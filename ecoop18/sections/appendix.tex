...
\end{lemma}
\begin{proof}
First, we will define a slightly different notion of models:
$$
\begin{array}{l}
\smodelsext{\sheap, \sstore, \senv}{\pc} = \left\{ (\heap, \store, \senv) \mid \semexpr{\sheap}{\senv} = \heap \, \wedge \, \semexpr{\sstore}{\senv} = \store \, \wedge \,  \senv \vdash \pc  \right\} \\
...
\smodelsext{\sheap, \sstore, \senv}{\pc} \subseteq \sepmodelsext{P} 
    \iff 
    \smodelsext{\sheap, \emptystore, \senv}{\pc} \subseteq \sepmodelsext{\symbeval{P}{\sstore}}.
\end{equation}
...
\end{array}$$
Now, we will prove the left-to-right direction (the right-to-left direction is analogous). We have two hypotheses: $\senv \satisfies \pc \implies
...
\begin{itemize}
    \item \prooflab{Cell unification failure} We conclude that there is a cell assertion $\cell$ 
              ...
              and $\smodels{\sheap'', \sstore}{\pc \, \wedge \, \pc'} \cap \sepmodels{\cell} = \emptyset$ (\ieq{8}). 
              ...
              From \ieq{6}, we conclude that 
              $\smodels{\sheap_f, \sstore}{\pc \, \wedge \, \pc'} \cap \sepmodels{\cell \lstcons \cells''} = \emptyset$ (\ieq{7}).
