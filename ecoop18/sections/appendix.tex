...
\begin{itemize}
    \item \prooflab{Cell unification failure} We conclude that there is a cell assertion $\cell$ 
              ...
              $\cellunificationiter{\sheap, \cells}{\sheap', \cell \lstcons -}{\pc}$ (\ieq{1}) 
              and $\cellunificationx{\sheap', \cell}{\uno{\pc''}}{\pc}$ (\ieq{2}), and  
              ...
              Applying Lemma~\ref{ca:unification:failure} to 
