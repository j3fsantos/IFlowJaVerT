...
\inferrule[\textsc{Assignment}]
  ...
  \inferrule[\textsc{Property Collection}]
  {
      ...
      \quad
        ...
        \quad
        (l, -) \not\in \domain(\sheap')
  }{\semtrans[][\top]{\heap, \store, \jvar := \getfields(\jsilexpr)}{\heap, \store[\jvar \mapsto \jsilset{\sexprp_0, ..., \sexprp_n}]}} 
%
\\
\inferrule[\textsc{Property Access}]
  { 
...
\medskip
All remaining cases follow directly from the definitions of the concrete and symbolic semantics and the fact that the heaps, stores, and call stacks are concrete.
\end{proof}
