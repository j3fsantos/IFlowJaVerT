...
and that $\sheap' = \sheap$, $\sstore' = \sstore[\jvar \mapsto \symbeval{\sexpr}{\store}]$, and $\pc' = \pc$. 
...
Noting that: 
$$
 \semtrans{\heap, \store, \jvar := \sexpr}{\heap, \store[\jvar \mapsto \symbeval{\sexpr}{\store}]}
% \qquad 
