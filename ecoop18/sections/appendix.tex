...
\begin{lemma}[Negative Resource]\label{lemma:negative:resource}
$$
\begin{array}{l}
...
$$
\begin{array}{l}
\symbeval{P}{\senv} \equiv (\existentials, \cells, \efs, \pfs') \ \wedge \ \unificationfull{\sheap, \sstore, \pc}{\cells, \pfs'}{\subst} \
