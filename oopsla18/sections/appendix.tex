...
%\vspace*{-0.3cm}
\begin{figure}[ht!]
\hspace{0.5cm}\textbf{Symbolic State Rules:\hfill}
{\scriptsize
\begin{mathpar} 
  ...
  %
   ...
   }{  \absgetdomainrule{(\sheap, \sdom, \sstore, \pc), (\jsilexpr_1, \jsilexpr_2)}{\sstate', (\sloc, \sexprp, \sexprv)}}
 %
 \\
 % 
     \inferrule[\textsc{GetCell - Domainl}]
   { 
         \symbeval{\jsilexpr_1}{\sstore} = \sloc
        \quad 
         \symbeval{\jsilexpr_2}{\sstore} = \sexprp
      ...
      \sdom(\sloc) = \sexprv
        \\\\
        %
       \pc \not\vdash \sexprp \in \sexprv 
       \quad 
       \sstate' = (\sheap, \sdom, \sstore, \pc \wedge \neg(\sexprp \in \sexprv))
   }{  \absgetdomainrule{(\sheap, \sdom, \sstore, \pc), (\jsilexpr_1, \jsilexpr_2)}{\sstate', (\sloc, \sexprp, \sexprv)}}
 \end{mathpar}}
% \pmax{What happens when we exit from main, how do we stop? Basically, cmd returns nothing and we can't reduce?}
 \vspace*{-0.6cm}
