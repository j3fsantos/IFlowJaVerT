...
\inferrule[\textsc{Basic Command}]
   { 
     ...
     \\\\
     \sembtransbasic{\absstate, \bcmd}{\absstate'} 
   }{\semrule{\absstate, \abscs, i}{\absstate', \abscs, i{+}1}{\top}{\top}}
  %
  \and
  %
  \inferrule[\textsc{Cond. Goto - True}]
   { \ccmd[\prog][\abscs]{i} =  \ifgoto{\jsilexpr}{j}{k} 
     \\\\
     \evalexpr(\jsilexpr, \absstate.\stosel) =  \jtrue
   }
   {\semrule{\jstate, \abscs, i}{\absstate, \abscs, j}{\top}{\top}}
  %
  \and 
  % 
  \inferrule[\textsc{Cond. Goto - False}]
   { \ccmd[\prog][\abscs]{i} =  \ifgoto{\jsilexpr}{j}{k} 
      \\\\ 
     \symbeval{\jsilexpr}{\absstate.\stosel} =  \jfalse
   }
   {\semrule{\absstate, \abscs, i}{\absstate, \abscs, k}{\top}{\top}}
  %
  \\
  %
  \inferrule[\textsc{Goto}]
   { 
   \ccmd[\prog][\cs]{i} = \goto \, j \quad}
   {\semrule{\absstate, \abscs, i}{\absstate, \abscs, j}{\top}{\top}}
   %
   \qquad 
   %
   \inferrule[\textsc{Normal Return}]
   {
       ...
       \\\\
       \absstate' = \absstate[\stosel \mapsto \absstore[\jvar \mapsto \val]]
   }  
   {\semrule{\absstate, \abscs, \procretlab}{\absstate', \abscs', i}{\top}{\top}}
     %
   \qquad 
   %
      \inferrule[\textsc{Error Return}]
   {
       ...
       \absstore = \absstate.\stosel
       \\\\
       \absstate' = \absstate[\stosel \mapsto \absstore[\jvar \mapsto \absval]]
   }  
   {\semrule{\absstate, \abscs, \procerrlab}{\absstate', \abscs', j}{\top}{\top}}
      \\
    \inferrule[\textsc{Procedure Call}]
   { 
    \ccmd[\prog][\cs]{i} =   \jsilcall{\jvar}{\jsilexpr}{\jsilexpr_i \mid_{i = 0}^{n}}{j}
