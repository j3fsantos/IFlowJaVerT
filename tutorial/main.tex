...
\begin{table}[!h]
    ...
    \begin{tabular}{|lcccc|}
    \hline
      % Exclusion Filters applied to obtain ES5S figure:
      % Harness, More indirect eval, noStrict labelled tests, ES6 only tests, AnnexB/Intl402
      % Indirect Eval, Indirect Eval (JSIL Unsupported), SJSIL ES6 new features, SJSIL ES5-6 breakages,
      % SJSIL ES6 Let, SJSIL ES6 Const
      % CONFIGURABLE LENGTH TODO
      \rowcolor{SkyBlue!40}
