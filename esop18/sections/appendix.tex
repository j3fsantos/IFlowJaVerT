...
\begin{itemize}
   \item $\efa = (\loc,\sexprp)\pointsto \none$ for some location $\loc$ and symbolic expression $\sexprp$. 
	    ...
	    From the hypothesis, \ieq{1}, and \ieq{9}, we conclude $\senv \satisfies   \sexprp \not\in \{  \sexprp_i \mid_{i = 0}^n \}$ (\ieq{10}), 
	    from which it follows that $(\loc, \symbeval{\sexprp}{\senv}) \not\in \domain(\symbeval{\sheap}{\senv}) = \domain(\heap)$ (\ieq{11}). 
	    From \ieq{9} and \ieq{11}, we conclude that $\heap \disjoint \iheap'$. 
	    \vspace{4pt}
  ...
  \item $\efa = \emptyfields{\loc}{\sexpr_d}$ for some location $\loc$ and symbolic expression $\sexpr_d$. 
	    ...
	    it immediately holds that $\heap \disjoint \iheap'$ and \dtag{ii} $\loc \in \eflocs(\sheap)$. 
	    Let us now prove the result for \dtag{ii}. 
	    It follows from $\efa = \emptyfields{\loc}{\sexpr_d}$ that $\iheap' = \uplus_{\jstring \not\in \symbeval{\sexprp}{\senv}}\big((\loc, \jstring) \mapsto \none\big)$ (\ieq{12}). 
            From \ieq{3}, and the definition of $\unificationef{\sheap}{\efs}$, 
	    we conclude that: 
	    $$
	       \unificationef{\sheap}{\efs} \vdash \unificationefl{\sheap}{\emptyfields{\loc}{\sexpr_d}} =  \{ \sexprp_i \mid_{i = 0}^n \} \subseteq \sexpr_d \text{ (\ieq{13})} 
	    $$
	    for $\sheap = \sheap' \dunion  \big((l, \sexprp_i) \mapsto \sexprv_i\big)\mid_{i = 0}^n$  
