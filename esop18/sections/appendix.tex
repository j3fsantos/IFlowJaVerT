...
$$
\begin{array}{l}
\unification{\sheap, \sstore, \pc}{\cell}{\subst}{\existentials} = \optionsome{(\subst', \sheap_f)} \\
	\qquad \implies 
...
$$
\begin{array}{l}
\unification{\sheap, \sstore, \pc}{\cell}{\subst}{\existentials} = {\optionnone} \\
...
%
 We start with the proof of the lemma for the case of \underline{successful unification}. 
 Hence, suppose it holds that: 
$\unification{\sheap, \sstore, \pc}{\cell}{\subst}{\existentials} = \optionsome{(\subst', \sheap_f)}$ (\hyp{1}). 
We proceed by case analysis on the rule used to derive \hyp{1}.
\vspace{6pt}

\noindent\prooflab{Cell Assertion} We conclude that $\cell = (\lexpr_l,\lexpr_p)\pointsto \lexpr_v$  and 
...
\noindent\prooflab{EmptyFields Assertion} We conclude that $\cell = \emptyfields{\lexpr_l}{\lexpr_d}$  and 
