...
we find a symbolic trace that results in a failed assertion with a satisfiable final path-condition, 
...
states that if we have symbolically explored all the possible paths
%
