...
include the abstraction mechanisms which would allow it to finitise \polish{[This word feels very Futamuric]"} the symbolic 
...
observing in detial the guarded unions produced by Rosette for each of 
the \jsil commands. Due to the its complexity and scale, 
\polish{a formal proof would require
...
To solve challenges 1 and 2, \jilette supports the on-the-fly addition of \rosette  
implementations of JavaScript internal functions. Hence, every time the interpreter 
