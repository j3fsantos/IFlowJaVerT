...
we describe its implementation in Rosette~\cite{Rosette1}.
...
\forall \, \sheap, \sstore, \sctx, i, \pc, \pc' \, . \,  \\ 
 \quad \symbtranstranserr{\sheap, \sstore, i, \pc}{\sctx}{\pc'}  \ \wedge \ \pc' {satisfiable} \implies 
...
\end{corollary}
%
The proofs of the results above are given in the Appendix. 
