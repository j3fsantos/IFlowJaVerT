...
\jilette works by first compiling JavaScript programs to \jsil using \JSComp, a well-tested, standard-compliant compiler from JavaScript to \jsil, and then symbolically executing the compiled \jsil code in the \jsil symbolic interpreter. 
...
and code. \polish{sound, no false positives}
\end{abstract}
