...
By design, Rosette lifts all 
of its natively supported solver-aided
features, such as advanced string reasoning, 
to this \jsil symbolic interpreter. 
We discuss the details of the implementation in \S\ref{sec:jsil:symb:exec}.
...
and allow the general developer to write assertions about the behaviour
of their program. Moreover, we adjust \JSComp so that the abstraction level 
of the generated \jsil code precisely matches the abstraction level of Rosette, 
thereby maximising the use of Rosette's native reasoning capabilities.
