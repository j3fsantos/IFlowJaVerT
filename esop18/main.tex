...
\jilette leverages on \underline{\JSComp}, a well-tested compiler from ES5 Strict to an 
...
First, we show how to use \jilette for the symbolic testing of JavaScript programs. 
