...
let js2jsil_predicate_def
	...
	{ name = pred_def.js_name; num_params = pred_def.js_num_params; params = jsil_params; ins = pred_def.js_ins; definitions = jsil_definitions; previously_normalised_pred = false }
