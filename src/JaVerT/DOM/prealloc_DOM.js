...
*/ /*
	...
	@pred AttributeSet(alpha, attrs) : 
		((alpha, "@chain") ->  #l) * AttributeSetRec(alpha, #l, attrs);

	@pred AttributeSetRec(root, l, attrs) : 
		isNil(attrs) * (l == $$null),
	...
	@pred Forest(alpha, childList) : 
		((alpha, "@chain") ->  #l) * ForestRec(alpha, #l, childList);

	@pred ForestRec(root, l, childList) :
	...
	@pred Grove(alpha, content) : 
		((alpha, "@chain") ->  #l) * GroveRec(alpha, #l, content);	
...
*/ /*
	...
	@onlyspec deallocAS(l, alpha)
		...
		post: [[ AttributeSet(l, #g_post) * (#g_post == (#g1 @ (#g2 @ #g3))) ]]
		outcome: normal; 
		...
		post: [[ AttributeSet(l, #g_post) * (#g_post == (#g1 @ #g3)) ]]
		outcome: normal;
		...
		post: [[ AttributeSet(l, #g_post) * (#g_post == (#g1 @ ({{"attr", #name, #id, #cList}} :: #g2))) ]]
		outcome: normal
	...
	@onlyspec deallocF(l, alpha)
		...
		post: [[ Forest(l, #g_post) * (#g_post == (#g1 @ (#g2 @ #g3))) ]]
		outcome: normal;

		pre:  [[ (alpha == #alpha) * types(#alpha : $$object_type, #g : $$list_type, #g1 : $$list_type, #g3 : $$list_type) * 
				 Forest(l, #g) * (#g == #g1 @ ({{ "hole", #alpha }} :: #g3)) * EmptyCell(#alpha) ]]
		post: [[ Forest(l, #g_post) * (#g_post == (#g1 @ #g3)) ]]
		outcome: normal; 

		pre:  [[ (alpha == #alpha) * types(#alpha : $$object_type, #g : $$list_type, #g1 : $$list_type, #g2 : $$list_type) * 
				 Forest(l, #g) * (#g == #g1 @ ({{ "hole", #alpha }} :: #g2)) * ECell(#alpha, #name, #id, #l_attr, #aList, #l_children, #cList) ]]
		post: [[ Forest(l, #g_post) * (#g_post == (#g1 @ ({{"elem", #name, #id, #aList, #cList}} :: #g2))) ]]
		outcome: normal;

		pre:  [[ (alpha == #alpha) * types(#alpha : $$object_type, #g : $$list_type, #g1 : $$list_type, #g2 : $$list_type) * 
				 Forest(l, #g) * (#g == #g1 @ ({{ "hole", #alpha }} :: #g2)) * TCell(#alpha, #id, #text) ]]
		post: [[ Forest(l, #g_post) * (#g_post == (#g1 @ ({{"text", #id, #text}} :: #g2))) ]]
		outcome: normal
	...
	@onlyspec deallocTF(l, alpha)
		...
		post: [[ TextForest(l, #g_post) * (#g_post == (#g1 @ (#g2 @ #g3))) ]]
		outcome: normal; 

		pre:  [[ (alpha == #alpha) * types(#alpha : $$object_type, #g : $$list_type, #g1 : $$list_type, #g3 : $$list_type) * 
				 TextForest(l, #g) * (#g == #g1 @ ({{ "hole", #alpha }} :: #g3)) * EmptyCell(#alpha) ]]
		post: [[ TextForest(l, #g_post) * (#g_post == (#g1 @ #g3)) ]]
		outcome: normal; 

		pre:  [[ (alpha == #alpha) * types(#alpha : $$object_type, #g : $$list_type, #g1 : $$list_type, #g2 : $$list_type) * 
				 TextForest(l, #g) * (#g == #g1 @ ({{ "hole", #alpha }} :: #g2)) * TCell(#alpha, #id, #text) ]]
		post: [[ TextForest(l, #g_post) * (#g_post == (#g1 @ ({{"text", #id, #text}} :: #g2))) ]]
		outcome: normal
...
*/ /*
	...
	@onlyspec nodeValue()
		...
		post: [[ ACell(#alpha, #name, this, #l_fList, #fList) * val(#fList, #s1) * (ret == #s1) * types(#s1 : $$string_type) ]]
		outcome: normal
	...
	@onlyspec insertBefore(m, n)
		...
		post: [[ ECell(#alpha, #name, this, #l_aList, #aList, #l_cList, #cList_post) *
				 (#cList_post == #a1 @ ({{ {{ "hole", #delta }}, {{ "hole", #beta }} }} @ #a2)) *
				 TCell(#beta, #m, #m_t) *
				 ECell(#delta, #n_name, #n, #n_l_a, #n_a, #n_l_c, #n_c) * complete(#n_c) *
				 EmptyCell(#gamma) * (ret == #n) ]]
		outcome: normal;
	...
	@onlyspec replaceChild(n, o)
		...
		post: [[ ECell(#alpha, #name, this, #l_aList, #aList, #l_cList, #cList_post) *
				 ...
				 ECell(#zeta2, #en_name, #en, #en_l_a, #en_a, #en_l_c, #en_c) * complete(#n_c) *
				 ECell(#beta, #o_name, #o, #o_l_a, #o_a, #o_l_c, #o_c) *
	...
	@onlyspec appendChild(n)
		...
		post: [[ ECell(#alpha, #name, this, #l_attr, #aList, #l_children, #cList_post ) * (#cList_post == #cList @ {{ {{ "hole", #beta2 }} }}) *
				 ECell(#beta2, #name2, #n, #l_attr2, #aList2, #l_children2, #cList2) * complete(#cList2) *
...
*/ /*
	...
	@onlyspec setAttribute(s, v)
		...
		post: [[ ECell(#alpha, #name, this, #l_aList, #aList_post, #l_children, #cList) * 
				 (#aList_post == {{ "hole", #gamma }} :: #aList) *  out(#aList, #s1) *
				 ACell(#gamma, #s1, #m, #l_t, {{ {{ "hole", #gamma2 }} }}) * 
	...
	@onlyspec getAttributeNode(s)
		...
		pre:  [[ (s == #s) * ECell(#alpha, #name, this, #l_aList, #aList, #l_children, #cList) * out(#aList, #s) ]]
		post: [[ ECell(#alpha, #name, this, #l_aList, #aList, #l_children, #cList) * out(#aList, #s) *(ret == $$null) ]]
		outcome: normal
...
*/ /*
	----Attribute Node Axioms----
*/ /*
	@onlyspec name()
		pre:  [[ ACell(#alpha, #name, this, #l_txtf, #txtf) ]]
		post: [[ ACell(#alpha, #name, this, #l_txtf, #txtf) * (ret == #name) ]]
		outcome: normal

	@onlyspec value()
		pre:  [[ ACell(#alpha, #name, this, #l_txtf, #txtf) * val(#txtf, #s) ]]
		post: [[ ACell(#alpha, #name, this, #l_txtf, #txtf) * val(#txtf, #s) * (ret == #s) ]]
		outcome: normal
