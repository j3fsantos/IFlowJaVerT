...
buckets.arrays.contains(elements, 0);
buckets.arrays.contains(elements, 1);
buckets.arrays.contains(elements, 2);
buckets.arrays.contains(elements, 3);
buckets.arrays.contains(elements, 4);
...
heap.add(8);
arr = heap.toArray();
buckets.arrays.contains(arr, 8);
buckets.arrays.contains(arr, 5);
arr.length;
