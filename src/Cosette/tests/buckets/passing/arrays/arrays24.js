...
var res1 = buckets.arrays.swap(numberArray, 0, 5);
var res2 = numberArray[0];
var res3 = numberArray[5];
var res4 = buckets.arrays.swap(numberArray, 0, 6);
var res5 = buckets.arrays.swap(numberArray, 7, 2);
var res6 = buckets.arrays.swap(numberArray, -1, 9);
Assert(res1);
Assert(res2 = n3);
Assert(res3 = n1);
Assert(not res4);
