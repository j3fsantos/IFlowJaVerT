...
var res1 = buckets.arrays.frequency(customObjectArray, test);
Assert(res1 = 0);

test.val = n1;
var res2 = buckets.arrays.frequency(customObjectArray, test, eq);
Assert(res2 = 2);

test.val = n2;
var res3 = buckets.arrays.frequency(customObjectArray, test, eq);
Assert(res3 = 1);
