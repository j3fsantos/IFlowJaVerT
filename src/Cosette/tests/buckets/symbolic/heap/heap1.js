...
var res = heap.removeRoot();
Assert(((x1 < x2) and (x1 < x3) and (x1 < x4) and (res = x1)) or ((x2 < x1) and (x2 < x3) and (x2 < x4) and (res = x2)) or ((x3 < x1) and (x3 < x2) and (x3 < x4) and (res = x3)) or ((x4 < x1) and (x4 < x2) and (x4 < x1) and (res = x4)));
